...
% A literatura classifica esse métodos em extração, mas por
% uma questão de clareza, ao longo deste documento serão
% classificados como combinação.
