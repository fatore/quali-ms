...
\usepackage[style=authoryear,maxcitenames=1,natbib=true, backend=bibtex, firstinits=true]{biblatex}
...
\title{Dual Projections: \\
Uma Nova Abordagem para Redução de Dimensionalidade e Exploração do Espaço de Atributos.}
